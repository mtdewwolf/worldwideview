...
- **Key test files**: `rateLimit.test.ts`, `edition.test.ts`, `demoAdmin.test.ts`, `loadPluginFromManifest.test.ts`, `cors.test.ts`, `repository.test.ts`, `marketplaceToken.test.ts`
